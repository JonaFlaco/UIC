...
@Component({
  ...
  styleUrls: ['./tutor-assignment-list.component.scss']
})
export class TutorAssignmentListComponent implements OnInit {
  ...
  // checkState(tutorAssignment: TutorAssignmentModel): string {
  //   if (tutorAssignment.id) return 'danger';
  ...
  getColumns(): ColumnModel[] {
    return [
         {field: 'project', header: 'Proyectos'},
        {field: 'projectPlan', header: 'Anteproyecto'},
         {field: 'type', header: 'Catalogo'},
